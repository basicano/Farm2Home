...
<table width=95% align="center">
<tr><td><font size="5"><b><h2>Vegetables</h2></td></tr>
</table><Br>

<table width=95% align="center" border="0" cellpadding="5">

	<?php
		$sql = "SELECT slno, name, mrp, price, image FROM products WHERE type='vegetable' ";
		...
		if($result->num_rows>0){
			...
			while($row=$result->fetch_assoc()){
				...
				<tr><td align="center"><a href="vegetables.php?add=<?php echo $row['slno'];?>"><b>BUY NOW</b></a></td></tr>
				</table>
				</td>
				<?php
